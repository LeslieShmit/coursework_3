...
list_of_companies = ["78638", "1740", "3529", "80", "11691810", "11485264", "856498", "8651204", "5685015", "9393023"]
...
def main():
    ...
    db_manager = DBManager(database_name="vacancies_db",
                             user=params["user"],
        ...
        if chosen_action == "1":
            ...
            for el in data:
                if el[2]:
                    ...
                    print(f"{el[1]}. Компания: {el[0]}, зарплата не указана, ссылка: {el[3]}")
